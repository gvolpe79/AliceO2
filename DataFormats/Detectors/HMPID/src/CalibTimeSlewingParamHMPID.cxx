...
#include <algorithm>
#include <cstdio>
#include "DataFormatsHMP/CalibTimeSlewingParamHMPID.h"

using namespace o2::dataformats;

CalibTimeSlewingParamHMPID::CalibTimeSlewingParamHMPID()
{
...
float CalibTimeSlewingParamHMPID::getChannelOffset(int channel) const
{
  return evalTimeSlewing(channel, 0);
}

//______________________________________________
float CalibTimeSlewingParamHMPID::evalTimeSlewing(int channel, float totIn) const
{
...
bool CalibTimeSlewingParamHMPID::updateOffsetInfo(int channel, float residualOffset)
{
